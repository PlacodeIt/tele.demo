...
# sample texts
messages = [
    "dear @verizonsupport your service is straight 💩 in dallas.. been with y'all over a decade and this is all time low "
    "for y'all. i'm talking no internet at all.",
    "@verizonsupport I sent you a dm",
    "thanks to michelle et al at @verizonsupport who helped push my no-show-phone problem along. Order canceled "
    "successfully, and I ordered this for pickup today at the Apple store in the mall. "
]
